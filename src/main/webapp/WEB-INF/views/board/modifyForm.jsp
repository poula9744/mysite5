	...
	<div id="wrap">
		...
		<div id="container" class="clearfix">
			...
			<div id="content">
				...
				<div id="board">
					<div id="modifyForm">
						<form action="${pageContext.request.contextPath}/board/modify?no=${BoardVo.no}" method="get">
							<!-- 고유번호 -->
							...
							<!-- 조회수 -->
							<div class="form-group">
								<span class="form-text">조회수</span> <span class="form-value">${boardVo.hits}</span>
							</div>
